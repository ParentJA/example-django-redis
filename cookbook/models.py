...
class Recipe(models.Model):
    ...
    ingredients = models.ManyToManyField('cookbook.Food', through='cookbook.Ingredient',
...
class Ingredient(models.Model):
    ...
    def __unicode__(self):
        return '{recipe}: {amount} {unit_of_measure} {food}'.format(recipe=self.recipe, amount=self.amount,
